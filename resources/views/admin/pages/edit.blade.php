...
@section('content')
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800">{{ __('Edit page') }}</h1>
<div class='row'>
    <div class="offset-lg-2 col-lg-8">
        <!-- Basic Card Example -->
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ __('Update page details') }}</h6>
            </div>
            <div class="card-body">
                <form action="{{ route('pages.update',['page' => $page->id]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <img src="{{ $page->image }}" alt="Page image" style="height: 100px; width: auto"><br>
                        <label>Image *</label>
